...
public class TutorialKing : TutorialChessFigure
{
    public override bool[,] PossibleMove(TutorialChessFigure[,] ChessFigurePositions)
    {
        ...
        TutorialChessFigure c2;
        TutorialChessFigure c3;
        TutorialChessFigure c4;
        int i, j;
        ...
        if (CurrentX > 3 && !hasMoved && !TutorialManager.inCheck)
        {
            c = ChessFigurePositions[CurrentX - 1, CurrentY];
        ...
        if (CurrentX < 5 && !hasMoved && !TutorialManager.inCheck)
        {
            c = ChessFigurePositions[CurrentX + 1, CurrentY];
            c2 = ChessFigurePositions[CurrentX + 2, CurrentY];
            c3 = ChessFigurePositions[CurrentX + 3, CurrentY];
