...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class ControlManagerUI : MonoBehaviour
    {
        ...
        public TMP_Text actionLabel
        {
            ...
            set
            {
                m_ActionLabel.text = value.ToString();
                UpdateActionLabel();
            }
        }
        ...
        public TMP_Text bindingText
        {
            ...
            set
            {
                m_BindingText.text = value.ToString();
                UpdateBindingDisplay();
            }
        }
        ...
        {
            get => m_RebindText;
            set => m_RebindText.text = value.ToString();
        }
        ...
        protected void OnEnable()
        {
            if (s_RebindActionUIs == null)
                s_RebindActionUIs = new List<ControlManagerUI>();
        ...
        private static List<ControlManagerUI> s_RebindActionUIs;
        ...
        [Serializable]
        public class UpdateBindingUIEvent : UnityEvent<ControlManagerUI, string, string, string>
        {
        }

        [Serializable]
        public class InteractiveRebindEvent : UnityEvent<ControlManagerUI, InputActionRebindingExtensions.RebindingOperation>
        {
        }
    }
}
