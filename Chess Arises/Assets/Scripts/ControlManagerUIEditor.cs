...
{
    /// <summary>
    /// A custom inspector for <see cref="ControlManagerUI"/> which provides a more convenient way for
    /// picking the binding which to rebind.
    /// </summary>
    [CustomEditor(typeof(ControlManagerUI))]
    public class ControlManagerUIEditor : UnityEditor.Editor
    {
